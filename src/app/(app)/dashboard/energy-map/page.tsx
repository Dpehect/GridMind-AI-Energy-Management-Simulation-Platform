...
export default function EnergyMapPage() {
  return (
    <main className="space-y-6 p-5 md:p-8">
      <PageHeader eyebrow="Phase 11" title="2D Building Energy Map" description="Inspect floors, compare zone intensity, locate devices and surface operational alerts in a single interactive workspace." actions={<FloorSelector />} />
